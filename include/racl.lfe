...
(defsyntax allow
 ([redis-server permission-name full-name key id]
  (progn
   (: er srem redis-server (mk-deny-key key full-name permission-name) id)
   (: er sadd redis-server (mk-allow-key key full-name permission-name) id))))

(defsyntax deny
 ([redis-server permission-name full-name key id]
  (progn
   (: er srem redis-server (mk-allow-key key full-name permission-name) id)
   (: er sadd redis-server (mk-deny-key key full-name permission-name) id))))
